      ...
      <div class="cells">
        ...
        <div class="cell">
          <label class="cellName">
            ...
            <span v-if="updateType == '2'">({{$t('window.assets.n')}})</span>
          </label>
        ...
        <div class="cell">
          <label>
            ...
            <span v-if="updateType == '3'">({{$t('window.assets.n')}})</span>
          </label>
          <span class="cellValue">{{updateType == '3' ? +updateContent/Math.pow(10,8) + +oldAssetSupply :oldAssetSupply}}</span>
        </div>
        <div class="cell">
          <label class="cellName">
            {{$t('window.assets.dbcyz')}}
            <span v-if="updateType == '1'">({{$t('window.assets.n')}})</span>
          </label>
          <span class="">{{updateType == '1' ? cutMiddleStr(updateContent,6):cutMiddleStr(oldAssetOwnerId,6)}}</span>
        </div>
        <div class="cell">
