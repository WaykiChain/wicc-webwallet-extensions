export default {
  ...
  account: {
    ...
    transDetail: {
      ...
      scoinstoliquidate:"Liquid coins",
      bcoinstostake:'Stake coins',
      scoinstomint:'Mint coins',
  ...
  window: {
    ...
    cdp:{
      xjmr:"Buy Limit",
      xjmc:"Sell Limit",
      sjmc:"Sell at Market Price",
      sjmr:"Buy at Market Price",
      slwicc:"Amount",
      jgwusd:"Price",
      hdslwusd:"Amount receive",
      slwusd:"Amount",
      hdslwicc:"Amount receive",
      dqscjg:"Currentmarketprice",
      yjhdwusd:"Expecttoreceive",
      yjhdwicc:"Expecttoreceive",
      sjcjwz:"Subjecttoactualtransaction",
      ...
      zjdyl:"Collateral Addition：",
      zjdcl:"Loans：",
      qsrdz:"Address：",
      qsl:"Assets for Liquidation：",
      ghl:"Repay：",
      shl:"Redemptions：",
